...
const slides: SlideProps[] = [
    {
        ...
        buttonLink: "/all-tools",
        bgPattern: "radial",
    },
    {
        title: "Save your favorites",
        subtitle:
            "Create your wishlist with the tools you use most often for quick access.",
    ...
    },
    {
        title: "Powerful & Fast",
        subtitle:
            "Lightning-fast tools that work directly in your browser with no installations required.",
    ...
    },
    {
        ...
        subtitle:
            "Search through our extensive collection to find exactly what you need.",
